...
SECRET_KEY = 'django-insecure-^2nqdrrxq=2v5z@zt_@_9t!c#)b9-vl%fl1)a7pi3wenl7&oo9'
...
WSGI_APPLICATION = 'NoticeProj.wsgi.application'
...
EMAIL_PORT = 587  # Use 465 for SSL (with EMAIL_USE_TLS=False, EMAIL_USE_SSL=True)
